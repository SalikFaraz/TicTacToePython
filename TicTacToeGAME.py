# python program to create a tic tac toe game
...
window.geometry('560x375')

# globally defining player and assigning it the value 1
player = 1
...
def checkWinner():
    if (button1['text'] == 'O' and button2['text'] == 'O' and button3['text'] == 'O' or
       button4['text'] == 'O' and button5['text'] == 'O' and button5['text'] == 'O' or
       ...
       button3['text'] == 'O' and button5['text'] == 'O' and button7['text'] == 'O'):
        messagebox._show("Winner of game", "Player O is winner i.e. Player 2")

    elif (button1['text'] == 'X' and button2['text'] == 'X' and button3['text'] == 'X' or
          button4['text'] == 'X' and button5['text'] == 'X' and button5['text'] == 'X' or
          ...
          button3['text'] == 'X' and button5['text'] == 'X' and button7['text'] == 'X'):
           messagebox._show("Winner of game", "Player X is winner i.e. Player 1")


# assigning values 'X' or 'O' accordingly player is '1' or '2'
...
# create Buttons and place them at a particular position which when clicked, 'X' or 'O' is displayed
# grid places our widgets in a table by dividing our window in row and columns
button1 = ttk.Button(window, text=" ", command=lambda: buttonPressed(1))
button1.grid(row=0, column=0, ipadx=50, ipady=50)
button2 = ttk.Button(window, text=" ", command=lambda: buttonPressed(2))
button2.grid(row=0, column=1, ipadx=50, ipady=50)
button3 = ttk.Button(window, text=" ", command=lambda: buttonPressed(3))
button3.grid(row=0, column=2, ipadx=50, ipady=50)
button4 = ttk.Button(window, text=" ", command=lambda: buttonPressed(4))
button4.grid(row=1, column=0, ipadx=50, ipady=50)
button5 = ttk.Button(window, text=" ", command=lambda: buttonPressed(5))
button5.grid(row=1, column=1, ipadx=50, ipady=50)
button6 = ttk.Button(window, text=" ", command=lambda: buttonPressed(6))
button6.grid(row=1, column=2, ipadx=50, ipady=50)
button7 = ttk.Button(window, text=" ", command=lambda: buttonPressed(7))
button7.grid(row=2, column=0, ipadx=50, ipady=50)
button8 = ttk.Button(window, text=" ", command=lambda: buttonPressed(8))
button8.grid(row=2, column=1, ipadx=50, ipady=50)
button9 = ttk.Button(window, text=" ", command=lambda: buttonPressed(9))
